...
class OxfordFlowers102(tfds.core.GeneratorBasedBuilder):
  ...
  def _split_generators(self, dl_manager):
    ...
    # WARNING: _BASE_URL was replaced by absolute URLs to Wayback Machine services due to HTTP 500 response from robots.ox.ac.uk
    dl_paths = dl_manager.download_and_extract({
        "images": os.path.join("https://web.archive.org/web/20211120003731if_/https://www.robots.ox.ac.uk/~vgg/data/flowers/102/", "102flowers.tgz"),
        "labels": os.path.join("https://web.archive.org/web/20211118132710if_/https://www.robots.ox.ac.uk/~vgg/data/flowers/102/", "imagelabels.mat"),
        "setid": os.path.join("https://web.archive.org/web/20211104122309if_/https://www.robots.ox.ac.uk/~vgg/data/flowers/102/", "setid.mat"),
    })
